...
//Ritmo 2021 Andorid v1.0 English credits
...
Yirlan Andrey Solano Sandoval (Yass)      - Student Assistant

Coding: Bonnie, Luscus , Yass   @mipmap/ic_logoespam
...
//selects a scene randomly. Deprecated and kept for debugging purposes 
 ...
 if(state==0)
   sceneCount=PApplet.parseInt(random(0,totalScenes));
}
